...
\tikzset{
object color/.style={blue!30!black!90!white,thick},
...
\newcommand{\tfigVolumeWithNormal}{
    \begin{tikzpicture}[scale=2]
        \draw[object color] (0,1,1) -- (0,1,0) -- (1,1,0) -- (1,0,0)
...
\newcommand{\tfigAreaWithCurveAndNormal}{
    \begin{tikzpicture}[scale=2.3]
        \draw[object color,rmidarrow=.1] (0,0) rectangle (1,1) node[below,right] {$C$};
        \node at (.5,.5) {$F$};
...
\newcommand{\tfigLinienintegral}{
    \begin{tikzpicture}[scale=2, clr/.style={lorange}]
        ...
        \draw[object color] (A) .. controls ($(A)+(NC)$) and ($(R)-(FC)$) .. (R) .. controls  ($(R)+(FC)$) and ($(B)-(NC)$) .. (B)
...
\newcommand{\tfigHalbkugel}{
    \begin{tikzpicture}[scale=2]
        \coordinate (A) at (0,0);
        \draw[object color] (0,0) arc (0:180:1) node[midway, above] {$F$};
        \draw[object color,dashed] (0,0) arc (0:180:1 and .3);
        \draw[object color,rmidarrow] (0,0) arc (0:-180:1 and .3) node[midway, below] {$C=\partial F$};
