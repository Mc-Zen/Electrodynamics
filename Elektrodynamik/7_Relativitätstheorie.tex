...
\begin{align*}
    \Lambda = \Lambda_R\Lambda_v, \quad \Lambda_R=\begin{pmatrix}
                  1      & \vec 0^T \\
                  \vec 0 & R
              \end{pmatrix}, \quad R\in mat_{3\times 3}.
\end{align*}
...
Raumzeit-Diagramme dienen zur Veranschaulichung von Bewegungen und Ereignissen in der Raumzeit. 
Zur Vereinfachung wird nur eine Raumdimension berücksichtigt. 

In \Abbref{fig:minkowski_diagram} ist ein einfaches Raumzeit-Diagramm dargestellt. 
...
\begin{figure}[htp]
    ...
    \caption{Weltlinie im Raumzeit-Diagramm mit Ortskoordinate auf der horizontalen und Zeitkoordinate auf der vertikalen Achse. Der Bereich $ct>0$ liegt in der Zukunft, der Bereich $ct<0$ in der Vergangenheit. Zeitartige Ereignisse und raumartige Ereignisse werden durch den Lichtkegel getrennt. }
